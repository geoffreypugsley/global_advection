...
def colocate_trajectories_with_isccp_utc_loop(trajectories_file, collection='isccp-basic', 
                                            product='hgg', varname='cldamt', dt_step_minutes=30):
    """
    ...
    while current_utc <= end_time:
        ...
        try:
            ...
            if len(active_parcels) > 0:
                ...
                isccp_values = granule.geolocate(lons, lats, collection, product, varname)
...
if __name__ == "__main__":
    ...
    output_file = "/disk1/Users/gjp23/outputs/traj_positions/global_analysis/trajectories_isccp_colocated_one_day_2016.nc"
    
    ds_colocated = colocate_trajectories_with_isccp_utc_loop(
            trajectories_file=trajectory_file,
            collection='isccp-basic',
            product='hgg',
            varname='cldamt',  # cloud top pressure
            dt_step_minutes=30
        )
